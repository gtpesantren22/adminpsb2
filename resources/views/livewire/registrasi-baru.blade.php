<div>
    ...
    <div class="page-content">
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Registrasi Santri Baru</h2>
                <p class="text-sm text-gray-500 mt-1">Kelola data administrasi pembayaran registrasi santri baru</p>
            </div>
        </div>
